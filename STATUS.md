...
- rev-001-002-measurements 分支：REV-001 环境固定脚本与 REV-002 四类局部测量已重建并保存原始结果（docs/reviews/2026-09-11/reproduction/）；8 项测量测试通过，本机完整套件 189 通过、5 跳过。内核候选仅在 benchmarks/ 评估，src/ 未改。
